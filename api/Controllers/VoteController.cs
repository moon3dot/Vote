...
public class VoteController : ControllerBase
{
    ...
    public async Task<ActionResult<Vote>> regVote([FromBody] Vote newVote)
    {
        Vote vote = new Vote
        {
            ...
            {
                Prd10To14 = newVote.SaturdayTime.Value,
                Prd11To15 = newVote.SaturdayTime.Value,
                Prd12To16 = newVote.SaturdayTime.Value,
                Prd13To17 = newVote.SaturdayTime.Value,
                Prd14To18 = newVote.SaturdayTime.Value,
                Prd15To19 = newVote.SaturdayTime.Value,
                Prd16To20 = newVote.SaturdayTime.Value,
                Prd17To21 = newVote.SaturdayTime.Value
            },
